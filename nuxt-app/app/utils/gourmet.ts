...
// Resolver una novedad abierta desbloquea "Finalizar" en ese cargue —
// TRANSPORTE y ADMIN (espejo de resolver.post.ts: el operario en cargue
// puede destrabar sus novedades sin depender del administrador).
export function puedeResolverNovedades(role: string): boolean { return ['TRANSPORTE', 'ADMIN'].includes(role) }
