// Helpers PUROS del módulo Estibas. Port 1:1 de src/lib/estibas.ts — ahí viven
// los tests, aquí lo consume Nitro. Sin Prisma a propósito: mapRow.ts importa de
// aquí y no debe arrastrar el cliente de Prisma al bundle (ver BUG-004 en
// docs/cerebro/bugs.md). Las dos copias deben mantenerse en sync.
