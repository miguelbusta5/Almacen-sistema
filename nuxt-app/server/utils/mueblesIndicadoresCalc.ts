// Indicadores del area de Muebles.
//
// Copia de src/lib/mueblesIndicadores.ts (fuente de verdad): Nitro no puede
// importar de src/lib. Hay un guard en src/__tests__/mueblesNuxt.test.ts que
...
import { inspeccionRepartida } from './mueblesCalc'
