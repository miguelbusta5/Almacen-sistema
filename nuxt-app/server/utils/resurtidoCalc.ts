// Logica pura del resurtido por tareas y de los pendientes, para Nitro.
//
// Copia de src/lib/resurtidoTareas.ts (fuente de verdad) — Nitro no puede
// importar de src/lib. Mantener en sync; hay tests que leen los dos archivos.
// normalizarUbicacion llega por el auto-import de montacargasCalc.ts.
