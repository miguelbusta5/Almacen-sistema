...
// Respiración consistente entre secciones del panel (más ancho que el SlidePanel
// genérico, así que el espaciado por defecto de DetailSection se siente apretado).
