    ...
    <div className="animate-fade-in">
      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 14, padding: "3rem 2rem", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 13, color: "var(--muted)", maxWidth: 400, margin: "0 auto" }}>
          El módulo de Novedades Muebles está siendo migrado al nuevo stack. Mientras tanto, usa la versión anterior.
        </div>
        <a
          href="https://miguelbusta5.github.io/novedades-muebles/muebles.html"
          target="_blank"
          rel="noopener noreferrer"
          style={{ display: "inline-flex", alignItems: "center", gap: 8, marginTop: "1.5rem", padding: "0.7rem 1.5rem", background: "var(--blue)", color: "#fff", borderRadius: 8, fontSize: 13, fontWeight: 700, textDecoration: "none" }}
        >
