...
export const HOME_ACTIONS: HomeAction[] = [
  ...
  {
    id: "control-montacargas",
    title: "Control montacargas",
    description: "Recepcion de contenedor y movimientos de deposito",
    href: "/dashboard/control-montacargas",
    icon: "Forklift",
  ...
  {
    id: "picking-muebles",
    title: "Picking Muebles",
    description: "Ordenes OVDM/TSDM con tiempos por PLU y capacidad del equipo",
    href: "/dashboard/picking-muebles",
    icon: "Hammer",
    color: getModuleColor("picking-muebles"),
    moduleKey: "picking-muebles",
    roles: ["PICKING_MUEBLES", "SUPERVISOR_ALMACENAMIENTO", "GERENTE", "ADMIN"],
    priority: 1,
  },
  {
    id: "inspeccion-muebles",
    title: "Inspeccion Muebles",
    description: "Ordenes por inspeccionar, envios a ebanisteria y pendientes",
    href: "/dashboard/inspeccion-muebles",
    icon: "ClipboardCheck",
    color: getModuleColor("inspeccion-muebles"),
    moduleKey: "inspeccion-muebles",
    roles: ["INSPECCION_MUEBLES", "SUPERVISOR_ALMACENAMIENTO", "GERENTE", "ADMIN"],
    priority: 1,
  },
  {
