// Validación de códigos de caja escaneados en Cargue Gourmet — compartida
// entre el modal de creación (cliente) y el endpoint de creación (servidor)
// para que las reglas nunca queden desincronizadas.
