...
export const ROLES_POR_TRANSICION_GOURMET: Record<string, string[]> = {
  ...
  "ENVIADO_A_TRANSPORTE-EN_CARGUE":          ["TRANSPORTE", "SUPERVISOR_TRANSPORTE", "ADMIN", "GERENTE"],
  "ENVIADO_A_TRANSPORTE-CANCELADO":          ["ADMIN", "GERENTE"],
  "EN_CARGUE-CARGUE_COMPLETO":               ["TRANSPORTE", "SUPERVISOR_TRANSPORTE", "ADMIN", "GERENTE"],
  "EN_CARGUE-CARGUE_COMPLETO_MANUAL":        ["SUPERVISOR_TRANSPORTE", "ADMIN", "GERENTE"],
  "EN_CARGUE-CON_NOVEDAD":                   ["TRANSPORTE", "SUPERVISOR_TRANSPORTE", "ADMIN", "GERENTE"],
  "CON_NOVEDAD-CARGUE_COMPLETO_MANUAL":      ["SUPERVISOR_TRANSPORTE", "ADMIN", "GERENTE"],
  "CON_NOVEDAD-EN_CARGUE":                   ["TRANSPORTE", "SUPERVISOR_TRANSPORTE", "ADMIN", "GERENTE"],
};
