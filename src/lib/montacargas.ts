// Helpers PUROS de Control Montacargas y Resurtido. Sin Prisma ni nada de
// runtime: los importan tanto los tests como el port de Nitro
// (nuxt-app/server/utils/montacargasCalc.ts), que debe mantenerse 1:1 con este
