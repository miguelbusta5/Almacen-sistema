// Lógica pura de Recepción de Contenedores: la planilla del CEDI.
//
// Fuente de verdad. Se replica en nuxt-app/server/utils/recepcionCalc.ts (Nitro)
// y nuxt-app/app/utils/recepcion.ts (Vue), que resuelven alias distintos y no
// pueden importar de aquí. Hay tests que leen los tres archivos y comparan.
