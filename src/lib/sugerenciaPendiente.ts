// Sugerencia de ubicacion para un pendiente de gourmet. Fuente de verdad y
// tests aqui; Nitro usa una copia identica en
// nuxt-app/server/utils/sugerenciaPendienteCalc.ts. Un test compara las dos.
