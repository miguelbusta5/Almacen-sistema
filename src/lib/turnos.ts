// Cuadro de turnos del almacenamiento: lo que convierte el Excel de Felipe en
// horarios con los que medir.
//
// Sin turno, los indicadores solo saben cuánto tiempo hubo un PLU en la mano,
// no cuánto de la jornada fue eso. Con el turno se puede decir "de 9 h 30 de
// turno, 6 h 35 con mercancía en la mano", que es la efectividad.
//
// El archivo son bloques: una fila "OPERARIO | LUNES | MARTES …" y debajo una
// fila por persona con "6am-3:30pm" o "DESCANSO". Hay un bloque por turno
// (mañana, tarde, noche) y el de la noche cruza la medianoche.
//
// Fuente de verdad. Se replica en nuxt-app/server/utils/turnosCalc.ts.
